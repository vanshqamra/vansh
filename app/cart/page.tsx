...
import { Minus, Plus, Trash2, ShoppingBag, ArrowRight, Beaker } from "lucide-react"
...
export default function CartPage() {
  ...
  const shippingCharges = totalPrice < 10000 ? 500 : 0
  const taxAmount = Math.round((totalPrice + shippingCharges) * 0.18)
  const finalTotal = totalPrice + shippingCharges + taxAmount
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-start justify-between">
                        <div>
                          ...
                          {item.packSize && <p className="text-sm text-slate-500">Pack Size: {item.packSize}</p>}
                        </div>
                        <Button
                          variant="ghost"
                          size="sm"
                      ...
                      <div className="flex items-center justify-between mt-4">
                        ...
                        <div className="text-right">
                          ...
                          <div className="text-sm text-slate-500">₹{item.price.toLocaleString()} per unit</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="space-y-3">
                  ...
                  {totalPrice < 10000 && (
                    <div className="text-xs text-amber-600 bg-amber-50 p-2 rounded">
                      Add ₹{(10000 - totalPrice).toLocaleString()} more for free shipping!
                    </div>
                  )}
                  <div className="flex justify-between">
                ...
                <div className="space-y-3 pt-4">
                  {user ? (
                    ...
                    <div className="space-y-2">
                      <Button size="lg" className="w-full" asChild>
                        <Link href="/login?redirect=/payments">Login to Continue</Link>
                      </Button>
